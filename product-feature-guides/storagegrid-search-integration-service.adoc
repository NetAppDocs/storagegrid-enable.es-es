...
+
image::sg-sis-select-permissions.png[Seleccione la captura de pantalla de permisos]
...
----
+
image::sg-sis-search-integration-amazon-opensearch.png[Captura de pantalla de integración de búsqueda]
...
+
image::sg-sis-activating-domain.png[Activando captura de pantalla del dominio]
...
+
image::sg-sis-using-put-command-for-index.png[Uso del comando put para la captura de pantalla de índice]

. Verifique que el índice sea visible desde la IU de Amazon OpenSearch en sgdomain > Indices.
+
image::sg-sis-verifying-the-index.png[Verificando-la captura de pantalla del índice]
...
+
image::sg-sis-enter-end-points-details.png[captura de pantalla de detalles finales]
...
+
image::sg-sis-authenticate-connections-to-endpoints.png[autenticar conexiones a la captura de pantalla de los extremos]
...
+
image::sg-sis-platform-service-endpoints.png[captura de pantalla de extremos de servicio de la plataforma]
...
+
image::sg-sis-search-integration-elasticsearch.png[integración de búsqueda captura de pantalla de búsqueda elástica]
...
+
image::sg-sis-execute-put-command.png[Ejecute la captura de pantalla del comando put]
...
+
image::sg-sis-platform-service-endpoint-details.png[Captura de pantalla de detalles del extremo de servicio de la plataforma]
...
+
image::sg-sis-platform-service-endpoint-authentication-type.png[Captura de pantalla de autenticación de extremo de servicio de plataforma]
...
+
image::sg-sis-successfully-verified-endpoint.png[Punto final verificado correctamente]
...
+
image::sg-sis-upload-test-objects.png[Cargar captura de pantalla de objetos de prueba]
...
----
+
image::sg-sis-query1-sample-result.png[Captura de pantalla de resultados de ejemplo de la consulta 1]
...
----
+
image::sg-sis-query-two-sample.png[Ejemplo de la consulta 2]
