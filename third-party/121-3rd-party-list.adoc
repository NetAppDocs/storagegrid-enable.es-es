...
summary: Soluciones de terceros validadas para StorageGRID 12.1 
---
...
[role="lead"]
Las siguientes soluciones de terceros han sido validadas para su uso con StorageGRID 12.1. + Si la solución que buscas no aparece en la lista, por favor contacta a tu representante de cuenta de NetApp.
