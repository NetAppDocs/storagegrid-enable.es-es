...
* 2 2024 de febrero:  https://community.netapp.com/t5/Tech-ONTAP-Blogs/Announcing-the-StorageGRID-lakeFS-Solution-Brief/ba-p/451465["Presentación del resumen de la solución StorageGRID + lakeFS"^]
