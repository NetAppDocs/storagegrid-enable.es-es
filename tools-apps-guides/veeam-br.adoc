...
image::veeam-bp/veeam_blk_sz.png[Una captura de pantalla de una descripción de computadora generada automáticamente,320,375]
...
Image::veeam-bp/S3_over_rates.png[S3 Tasas de visión general]
