...
. Consulta la  https://docs.cloudera.com/cdp-private-cloud-upgrade/latest/upgrade/topics/cdpdc-java-requirements.html["Matriz de compatibilidad de Cloudera"^] para conocer la versión de JDK compatible.
