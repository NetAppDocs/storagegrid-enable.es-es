...
+
image:load-balancer-monitor-configuration-page.png["Página de configuración del monitor"]
...
image:load-balancer-citrix-netscaler-configuration-page.png["Página de configuración de Citrix Netscaler Monitor"]
