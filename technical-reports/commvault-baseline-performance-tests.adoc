...
[role="lead"]
En la operación Aux Copy, cuatro MediaAgents de Commvault realizaron una copia de seguridad de los datos en un sistema NetApp AFF A300 y se creó una copia auxiliar en NetApp StorageGRID.
