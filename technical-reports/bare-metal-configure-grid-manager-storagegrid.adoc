...
. link:bare-metal-storagegrid-license.html["Especifique la información de licencia de StorageGRID"]
. link:bare-metal-add-sites-storagegrid.html["Agregar sitios a StorageGRID"]
. link:bare-metal-grid-network-subnets-storagegrid.html["Especifique las subredes de red de cuadrícula"]
. link:bare-metal-approve-grid-nodes-storagegrid.html["Aprobar los nodos de cuadrícula pendientes"]
. link:bare-metal-ntp-server-storagegrid.html["Especifique la información del servidor NTP"]
. link:bare-metal-dns-server-storagegrid.html["Especifique la información del servidor del sistema de nombres de dominio"]
. link:bare-metal-system-passwords-storagegrid.html["Especifique las contraseñas del sistema StorageGRID"]
. link:bare-metal-review-config-complete-storagegrid-install.html["Revise la configuración y complete la instalación"]
