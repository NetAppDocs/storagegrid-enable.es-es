...
El formato de la policía JSON se verá así:
...
* Introduzca la información del bloque: arn:aws:S3:::examplebucket,arn:aws:S3:::examplebucket/*
...
image:policy/permission3.png["Segundo permiso en la política"]
