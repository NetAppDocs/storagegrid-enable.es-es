...
Esta política sólo permitirá a los usuarios acceder a los objetos del bloque denominado nombre de usuario del usuario.
...
Esta política restringirá a los usuarios a crear un bloque con el bloqueo de objetos activado en el bloque.
